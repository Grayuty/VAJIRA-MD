...
global.owner = process.env.OWNER_NUMBER  || '2347060521857' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=iQNVnTpQ#e3uh0wKb4UjhQFzr8IBuzKYwbXqAUo0bfsabGip_h1c' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || '𝘤𝘩𝘶𝘬𝘸𝘶𝘦𝘣𝘶𝘬𝘢 𝘈' ,
